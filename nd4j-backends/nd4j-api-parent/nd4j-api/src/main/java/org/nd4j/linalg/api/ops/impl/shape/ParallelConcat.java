...
/**
 * Stacks n input tensors of same shape (with 1st dim = 1) to tensor of rank n.
 *
...
public class ParallelConcat extends DynamicCustomOp {
    ...
    public ParallelConcat(SameDiff sameDiff, SDVariable[] values) {
